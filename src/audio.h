...
namespace Audio {
    ...
    void play(const Sound_ID sound, int audio_diff=0, int loops=0);
    ...
    void play_fadein(const Sound_ID sound, const s32 fadein_ms, int audio_diff=0, int loops=0);

    // NOTE(jerry): helper to cover common case...
    void play_music_transition_into(const Sound_ID sound, const s32 fadeout_ms, const s32 fadein_ms, int audio_diff = 0, int loops = 0);
