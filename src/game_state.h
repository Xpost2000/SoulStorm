...
/*
  ...
  NOTE: I'm not too sure how often I'll use it outside of the level code,
  but it's nice to have.

  NOTE: coroutines will execute at the end of the frame.
 */
enum { GAME_TASK_AVALIABLE, GAME_TASK_SOURCE_UI, GAME_TASK_SOURCE_GAME, GAME_TASK_SOURCE_ALWAYS };
