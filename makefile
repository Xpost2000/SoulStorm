CC=g++
CFLAGS=-Wno-unused -Wno-unused-but-set-variable -std=c++11
...
SOURCE_FILES= src/main.cpp src/audio.cpp src/memory_arena.cpp src/v2.cpp src/input.cpp src/string.cpp src/thread_pool.cpp src/engine.cpp src/graphics.cpp
