...
## modules 
./build_intermediaries/achievements.o: src/achievements.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/achievements.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/action_mapper.o: src/action_mapper.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/action_mapper.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/allocators.o: src/allocators.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/allocators.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/audio.o: src/audio.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/audio.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/camera.o: src/camera.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/camera.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/color.o: src/color.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/color.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/common.o: src/common.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/common.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/debug_ui.o: src/debug_ui.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/debug_ui.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/engine.o: src/engine.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/engine.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/entity.o: src/entity.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/entity.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/entity_prototypes.o: src/entity_prototypes.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/entity_prototypes.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/fade_transition.o: src/fade_transition.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/fade_transition.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/game.o: src/game.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/game.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/bigfile.o: Bigfilepacker/bigfile.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c Bigfilepacker/bigfile.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/glad.o: glad/src/glad.c $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c glad/src/glad.c $(CFLAGS) $(CLIBS) 
./build_intermediaries/game_task_scheduler.o: src/game_task_scheduler.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/game_task_scheduler.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/game_ui.o: src/game_ui.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/game_ui.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/graphics_assets.o: src/graphics_assets.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/graphics_assets.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/graphics_driver.o: src/graphics_driver.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/graphics_driver.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/graphics_driver_null.o: src/graphics_driver_null.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/graphics_driver_null.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/graphics_driver_opengl.o: src/graphics_driver_opengl.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/graphics_driver_opengl.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/graphics_driver_d3d11.o: src/graphics_driver_d3d11.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/graphics_driver_d3d11.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/graphics_driver_software.o: src/graphics_driver_software.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/graphics_driver_software.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/v2_lua_bindings.o: src/v2_lua_bindings.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/v2_lua_bindings.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/entity_lua_bindings.o: src/entity_lua_bindings.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/entity_lua_bindings.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/game_lua_bindings.o: src/game_lua_bindings.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/game_lua_bindings.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/virtual_file_system.o: src/virtual_file_system.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/virtual_file_system.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/particle_system.o: src/particle_system.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/particle_system.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/particle_system_lua_bindings.o: src/particle_system_lua_bindings.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/particle_system_lua_bindings.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/input.o: src/input.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/input.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/lightmask_buffer.o: src/lightmask_buffer.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/lightmask_buffer.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/main.o: src/main.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/main.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/memory_arena.o: src/memory_arena.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/memory_arena.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/prng.o: src/prng.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/prng.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/render_commands.o: src/render_commands.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/render_commands.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/serializer.o: src/serializer.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/serializer.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/software_renderer.o: src/software_renderer.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/software_renderer.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/discord_rich_presence_integration.o: src/discord_rich_presence_integration.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/discord_rich_presence_integration.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/stage.o: src/stage.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/stage.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/string.o: src/string.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/string.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/thread_pool.o: src/thread_pool.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/thread_pool.cpp $(CFLAGS) $(CLIBS) 
./build_intermediaries/v2.o: src/v2.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/v2.cpp $(CFLAGS) $(CLIBS) 

# NOTE: could be made as one target... with suffixing
./build_intermediaries/achievements_debug.o: src/achievements.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/achievements.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/action_mapper_debug.o: src/action_mapper.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/action_mapper.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/allocators_debug.o: src/allocators.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/allocators.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/audio_debug.o: src/audio.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/audio.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/camera_debug.o: src/camera.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/camera.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/color_debug.o: src/color.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/color.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/common_debug.o: src/common.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/common.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/debug_ui_debug.o: src/debug_ui.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/debug_ui.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/engine_debug.o: src/engine.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/engine.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/entity_debug.o: src/entity.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/entity.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/entity_prototypes_debug.o: src/entity_prototypes.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/entity_prototypes.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/fade_transition_debug.o: src/fade_transition.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/fade_transition.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/game_debug.o: src/game.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/game.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/bigfile_debug.o: Bigfilepacker/bigfile.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c Bigfilepacker/bigfile.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/glad_debug.o: glad/src/glad.c $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c glad/src/glad.c -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/game_task_scheduler_debug.o: src/game_task_scheduler.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/game_task_scheduler.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/game_ui_debug.o: src/game_ui.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/game_ui.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/graphics_assets_debug.o: src/graphics_assets.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/graphics_assets.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/graphics_driver_debug.o: src/graphics_driver.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/graphics_driver.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/graphics_driver_null_debug.o: src/graphics_driver_null.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/graphics_driver_null.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/graphics_driver_opengl_debug.o: src/graphics_driver_opengl.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/graphics_driver_opengl.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/graphics_driver_d3d11_debug.o: src/graphics_driver_d3d11.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/graphics_driver_d3d11.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/graphics_driver_software_debug.o: src/graphics_driver_software.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/graphics_driver_software.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/v2_lua_bindings_debug.o: src/v2_lua_bindings.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/v2_lua_bindings.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/entity_lua_bindings_debug.o: src/entity_lua_bindings.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/entity_lua_bindings.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/game_lua_bindings_debug.o: src/game_lua_bindings.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/game_lua_bindings.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/virtual_file_system_debug.o: src/virtual_file_system.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/virtual_file_system.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/particle_system_debug.o: src/particle_system.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/particle_system.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/particle_system_lua_bindings_debug.o: src/particle_system_lua_bindings.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/particle_system_lua_bindings.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/input_debug.o: src/input.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/input.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/lightmask_buffer_debug.o: src/lightmask_buffer.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/lightmask_buffer.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/main_debug.o: src/main.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/main.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/memory_arena_debug.o: src/memory_arena.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/memory_arena.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/prng_debug.o: src/prng.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/prng.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/render_commands_debug.o: src/render_commands.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/render_commands.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/serializer_debug.o: src/serializer.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/serializer.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/software_renderer_debug.o: src/software_renderer.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/software_renderer.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/discord_rich_presence_integration_debug.o: src/discord_rich_presence_integration.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/discord_rich_presence_integration.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/stage_debug.o: src/stage.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/stage.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/string_debug.o: src/string.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/string.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/thread_pool_debug.o: src/thread_pool.cpp $(HEADER_FILES) ./build_intermediaries/
	$(CC) -o $@ -c src/thread_pool.cpp -g $(CFLAGS) $(CLIBS) 
./build_intermediaries/v2_debug.o: src/v2.cpp$(HEADER_FILES) ./build_intermediaries/
