...
main.c -O2 -lSDL2_mixer -lSDL2 -s USE_SDL_MIXER=2 -s USE_SDL=2 -s USE_WEBGL2=1 -I./dependencies/ -o game.html -s INITIAL_MEMORY=256MB --preload-file res --preload-file areas --preload-file shops --preload-file dlg --preload-file scenes -DRELEASE
